...
public partial class BilderContext : DbContext
{
    public BilderContext()
    {
    }

    public BilderContext(DbContextOptions<BilderContext> options)
        : base(options)
    {
    }
